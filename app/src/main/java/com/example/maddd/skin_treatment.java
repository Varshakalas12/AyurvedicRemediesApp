...
public class skin_treatment extends AppCompatActivity {
  ...
  TextView txt11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skin_treatment);

        DatabaseReference databaseRefernce = FirebaseDatabase.getInstance().getReference("datausers").child("SkinTreatment");
