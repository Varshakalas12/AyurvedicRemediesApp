...
public class kidneystone extends AppCompatActivity {
  ...
  TextView txt5;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kidneystone);
        DatabaseReference databaseRefernce = FirebaseDatabase.getInstance().getReference("datausers").child("KidneyStone");
