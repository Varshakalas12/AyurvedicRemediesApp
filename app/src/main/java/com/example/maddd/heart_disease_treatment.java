...
public class heart_disease_treatment extends AppCompatActivity {
   ...
   TextView txt3;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_heart_disease_treatment);
        DatabaseReference databaseRefernce = FirebaseDatabase.getInstance().getReference("datausers").child("HeartDisease");
