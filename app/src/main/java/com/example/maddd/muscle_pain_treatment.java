...
public class muscle_pain_treatment extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_muscle_pain_treatment);
        DatabaseReference databaseRefernce = FirebaseDatabase.getInstance().getReference("datausers").child("MusclePain");
